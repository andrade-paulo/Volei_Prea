...
export const playersTable =
  "grid w-full grid-cols-[minmax(0,2fr)_minmax(2rem,0.55fr)_minmax(2.25rem,0.7fr)_minmax(2.25rem,0.7fr)_minmax(2.25rem,0.7fr)_minmax(1.75rem,0.5fr)_minmax(4.25rem,auto)] gap-x-1 gap-y-1.5 sm:gap-x-2 sm:gap-y-2";
...
export const historyPlayersDataStrip =
  "col-span-6 col-start-1 grid grid-cols-subgrid items-center border border-black bg-[#b0b0b0] py-2 sm:py-3";
...
export const historyPlayersActionsCell =
  "col-start-7 flex flex-row items-center justify-center gap-1";
